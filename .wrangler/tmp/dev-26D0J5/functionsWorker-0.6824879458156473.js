...
// .wrangler/tmp/pages-cBssBk/functionsWorker-0.6824879458156473.mjs
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_22529849685095882();
...
var init_route = __esm({
  "api/[[route]].ts"() {
    ...
    v1.patch("/categories/:id", async (c) => {
      const id = c.req.param("id");
      const db = c.get("db");
      const body = await c.req.json();
    ...
    v1.delete("/categories/:id", async (c) => {
      const id = c.req.param("id");
      const db = c.get("db");
...
var routes;
var init_functionsRoutes_0_22529849685095882 = __esm({
  "../.wrangler/tmp/pages-cBssBk/functionsRoutes-0.22529849685095882.mjs"() {
    init_route();
    init_slug();
    routes = [
      {
...
// .wrangler/tmp/bundle-HoTQFG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-HoTQFG/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6824879458156473.js.map
