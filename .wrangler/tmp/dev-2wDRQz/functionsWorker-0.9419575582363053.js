...
// .wrangler/tmp/pages-jPz0oA/functionsWorker-0.9419575582363053.mjs
...
var __copyProps = /* @__PURE__ */ __name((to, from, except2, desc6) => {
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key of __getOwnPropNames(from))
      if (!__hasOwnProp.call(to, key) && key !== except2)
        __defProp2(to, key, { get: /* @__PURE__ */ __name(() => from[key], "get"), enumerable: !(desc6 = __getOwnPropDesc(from, key)) || desc6.enumerable });
  }
  return to;
}, "__copyProps");
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_5678900032968975();
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.products.findMany({
          ...
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name2((p, { desc: desc6, asc: asc2 }) => {
            if (sort === "newest") return [desc6(p.createdAt)];
            if (sort === "price-low") return [asc2(p.price)];
            if (sort === "price-high") return [desc6(p.price)];
            if (sort === "best-selling") return [desc6(p.soldCount)];
            if (sort === "trending") return [desc6(p.rating)];
            return [desc6(p.createdAt)];
          }, "orderBy")
        });
        return c.json(createPaginatedResponse(
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          ...
          orderBy: /* @__PURE__ */ __name2((o, { desc: desc6 }) => [desc6(o.createdAt)], "orderBy")
        });
        return c.json({
  ...
  "api/routers/addresses.ts"() {
    ...
    addressesRouter.get("/", async (c) => {
      ...
      const rows = await db.query.addresses.findMany({
        ...
        orderBy: /* @__PURE__ */ __name2((a, { desc: desc6 }) => [desc6(a.isDefault), desc6(a.createdAt)], "orderBy")
      });
      return c.json({
  ...
  "api/routers/reviews.ts"() {
    ...
    reviewsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.reviews.findMany({
        ...
        orderBy: /* @__PURE__ */ __name2((r, { desc: desc6 }) => [desc6(r.createdAt)], "orderBy")
      });
      let stats = null;
      if (productId) {
  ...
  "api/routers/coupons.ts"() {
    ...
    couponsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.coupons.findMany({
        orderBy: /* @__PURE__ */ __name2((cp, { desc: desc6 }) => [desc6(cp.createdAt)], "orderBy")
      });
      return c.json({
...
var init_dashboard = __esm({
  "api/routers/dashboard.ts"() {
    ...
    dashboardRouter.get("/stats", async (c) => {
      ...
      const [pendingCount] = await db.select({ count: sql`count(*)` }).from(otpCodes).where(sql`type = 'email_verify' AND used = 0 AND expires_at > ${Date.now()}`);
      const [totalRevenue] = await db.select({ total: sql`sum(totalAmount)` }).from(orders);
      const growth = {
        revenue: "+12.5%",
        users: "+8.2%",
        orders: "+15.0%"
  ...
  "api/routers/wallet.ts"() {
    ...
    walletRouter.get("/", async (c) => {
      ...
      const rows = await db.query.walletTransactions.findMany({
        ...
        orderBy: /* @__PURE__ */ __name2((t, { desc: desc6 }) => [desc6(t.createdAt)], "orderBy")
      });
    ...
    notificationsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.notifications.findMany({
          ...
          orderBy: /* @__PURE__ */ __name2((n, { desc: desc6 }) => [desc6(n.createdAt)], "orderBy")
        });
      ...
      try {
        const [
          ...
          db.query.addresses.findMany({
            where: /* @__PURE__ */ __name2((a, { eq: eq2 }) => eq2(a.userId, userId), "where"),
            orderBy: /* @__PURE__ */ __name2((a, { desc: desc6 }) => [desc6(a.createdAt)], "orderBy")
          }),
          // 4. Orders (by customerName if provided, otherwise we'd need email matching but name is used in this app)
          ...
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and2 }) => and2(eq2(r.userId, userId), eq2(r.type, "return")), "where"),
            orderBy: /* @__PURE__ */ __name2((r, { desc: desc6 }) => [desc6(r.createdAt)], "orderBy")
          }),
          // 6. Cancellations
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and2 }) => and2(eq2(r.userId, userId), eq2(r.type, "cancellation")), "where"),
            orderBy: /* @__PURE__ */ __name2((r, { desc: desc6 }) => [desc6(r.createdAt)], "orderBy")
          }),
          // 7. Reviews
          ...
          db.query.notifications.findMany({
            where: /* @__PURE__ */ __name2((n, { eq: eq2, and: and2, or: or2, isNull: isNull2 }) => and2(
              eq2(n.isRead, 0),
              or2(eq2(n.userId, userId), isNull2(n.userId))
            ), "where")
          })
        ]);
        return c.json({
...
var init_system = __esm({
  "api/routers/system.ts"() {
    ...
    systemRouter.get("/bulk/home", async (c) => {
      const db = c.get("db");
      try {
        const [
          bannersHero,
          ...
          db.query.products.findMany({
            limit: 10,
            orderBy: /* @__PURE__ */ __name2((p, { desc: desc6 }) => [desc6(p.rating)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 8,
            where: /* @__PURE__ */ __name2((p, { like: like2 }) => like2(p.tags, '%"new-arrival"%'), "where"),
            orderBy: /* @__PURE__ */ __name2((p, { desc: desc6 }) => [desc6(p.createdAt)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 4,
          ...
          db.query.products.findMany({
            ...
            orderBy: /* @__PURE__ */ __name2((p, { desc: desc6 }) => [desc6(p.soldCount)], "orderBy")
          }),
          db.query.notifications.findMany({
...
var routes;
var init_functionsRoutes_0_5678900032968975 = __esm({
  "../.wrangler/tmp/pages-jPz0oA/functionsRoutes-0.5678900032968975.mjs"() {
    init_app();
    init_route();
    init_slug();
    routes = [
...
// .wrangler/tmp/bundle-uQ0ZK9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-uQ0ZK9/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9419575582363053.js.map
