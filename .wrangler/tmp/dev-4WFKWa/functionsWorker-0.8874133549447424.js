...
// .wrangler/tmp/pages-OXFWQ6/functionsWorker-0.8874133549447424.mjs
...
var __copyProps = /* @__PURE__ */ __name((to, from, except2, desc3) => {
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key of __getOwnPropNames(from))
      if (!__hasOwnProp.call(to, key) && key !== except2)
        __defProp2(to, key, { get: /* @__PURE__ */ __name(() => from[key], "get"), enumerable: !(desc3 = __getOwnPropDesc(from, key)) || desc3.enumerable });
  }
  return to;
}, "__copyProps");
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_709371772397853();
    ...
    bannersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.banners.findMany({
          where: position ? (b, { eq: eq3 }) => eq3(b.position, position) : void 0,
    ...
    categoriesRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.categories.findMany({
          where: /* @__PURE__ */ __name2((cat, { eq: eq3, and: and3 }) => {
            if (showAll && !featured) return void 0;
            const filters = [];
            if (!showAll) filters.push(eq3(cat.isActive, 1));
            if (featured) filters.push(eq3(cat.isFeatured, 1));
  ...
  "api/routes/products.ts"() {
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        if (category) {
          whereClause = eq(products.categoryId, category);
        }
        const [totalRes] = await db.select({ count: count() }).from(products);
        const total = totalRes.count;
        const rows = await db.query.products.findMany({
          where: whereClause,
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name2((p, { desc: desc3, asc: asc2 }) => {
            if (sort === "newest") return [desc3(p.createdAt)];
            if (sort === "price-low") return [asc2(p.price)];
            if (sort === "price-high") return [desc3(p.price)];
            return [desc3(p.rating)];
          }, "orderBy")
        });
...
var init_orders2 = __esm({
  "api/routes/orders.ts"() {
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          where: customerName ? (o, { eq: eq3 }) => eq3(o.customerName, customerName) : void 0,
          orderBy: /* @__PURE__ */ __name2((o, { desc: desc3 }) => [desc3(o.createdAt)], "orderBy")
        });
        return c.json({
    ...
    ordersRouter.post("/", async (c) => {
      ...
      for (const item of body.items) {
        const [product] = await db.select().from(products).where(eq(products.id, item.productId));
        await db.update(products).set({ stock: (product.stock ?? 0) - item.quantity }).where(eq(products.id, item.productId));
      }
      const id = crypto.randomUUID();
  ...
  "api/routes/addresses.ts"() {
    ...
    addressesRouter.get("/", async (c) => {
      ...
      const rows = await db.query.addresses.findMany({
        where: /* @__PURE__ */ __name2((a, { eq: eq3 }) => eq3(a.userId, userId), "where"),
        orderBy: /* @__PURE__ */ __name2((a, { desc: desc3 }) => [desc3(a.isDefault), desc3(a.createdAt)], "orderBy")
      });
      return c.json({
...
var init_reviews2 = __esm({
  "api/routes/reviews.ts"() {
    ...
    reviewsRouter.get("/", async (c) => {
      ...
      let whereClause;
      if (productId) {
        whereClause = /* @__PURE__ */ __name2((r, { eq: eq3 }) => eq3(r.productId, productId), "whereClause");
      } else if (userId) {
        whereClause = /* @__PURE__ */ __name2((r, { eq: eq3 }) => eq3(r.userId, userId), "whereClause");
      }
      const rows = await db.query.reviews.findMany({
        where: whereClause,
        orderBy: /* @__PURE__ */ __name2((r, { desc: desc3 }) => [desc3(r.createdAt)], "orderBy")
      });
      let stats = null;
  ...
  "api/routes/returns.ts"() {
    ...
    returnsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.returns.findMany({
        where: /* @__PURE__ */ __name2((r, { eq: eq3, and: and3 }) => {
          const conditions = [];
          if (userId) conditions.push(eq3(r.userId, userId));
          if (type) conditions.push(eq3(r.type, type));
  ...
  "api/routes/coupons.ts"() {
    ...
    couponsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.coupons.findMany({
        orderBy: /* @__PURE__ */ __name2((cp, { desc: desc3 }) => [desc3(cp.createdAt)], "orderBy")
      });
      return c.json({
...
var routes;
var init_functionsRoutes_0_709371772397853 = __esm({
  "../.wrangler/tmp/pages-OXFWQ6/functionsRoutes-0.709371772397853.mjs"() {
    init_route();
    init_slug();
    routes = [
      {
...
// .wrangler/tmp/bundle-U0RgZy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-U0RgZy/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8874133549447424.js.map
