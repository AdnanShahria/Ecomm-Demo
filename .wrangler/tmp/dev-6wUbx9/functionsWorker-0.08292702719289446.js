...
// .wrangler/tmp/pages-IM4Jfq/functionsWorker-0.08292702719289446.mjs
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_13817121717926384();
  ...
  "api/[[route]].ts"() {
    ...
    reviewsRouter.patch("/:id", async (c) => {
      ...
      if (body.rating !== void 0) {
        const allReviews = await db.select().from(reviews).where(eq(reviews.productId, existing.productId));
        const avgRating = allReviews.reduce((sum, r) => sum + r.rating, 0) / allReviews.length;
        await db.update(products).set({
          rating: Math.round(avgRating * 10) / 10
...
var routes;
var init_functionsRoutes_0_13817121717926384 = __esm({
  "../.wrangler/tmp/pages-IM4Jfq/functionsRoutes-0.13817121717926384.mjs"() {
    init_route();
    init_slug();
    routes = [
      {
...
// .wrangler/tmp/bundle-9aBleu/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9aBleu/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.08292702719289446.js.map
