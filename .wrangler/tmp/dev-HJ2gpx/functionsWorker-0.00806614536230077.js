...
// .wrangler/tmp/pages-J3es4s/functionsWorker-0.00806614536230077.mjs
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_251086712123578();
...
var init_route = __esm({
  "api/[[route]].ts"() {
    ...
    app.use("*", logger());
    app.use("*", cors());
    authMiddleware = /* @__PURE__ */ __name2(async (c, next) => {
    ...
    app.onError((err, c) => {
      ...
      const isDbInitError = err.message.includes("Database client not initialized") || err.message.includes("TURSO_URL");
      ...
      return c.json({
        ...
        hint: isDbInitError ? "Please check your environment variables for TURSO_URL and TURSO_AUTH_TOKEN." : void 0,
    ...
    app.get("/categories", async (c) => {
      try {
        ...
        const rows = await db.query.categories.findMany({
          where: featured ? (cat, { eq: eq2 }) => eq2(cat.isFeatured, 1) : void 0
        });
        return c.json(rows);
      } catch (error) {
    ...
    app.get("/products/search", async (c) => {
      try {
        ...
        if (!db) return c.json([]);
        const rows = await db.query.products.findMany({
          where: /* @__PURE__ */ __name2((p, { like: like2 }) => like2(p.title, `%${q}%`), "where"),
          limit: 5
        });
        return c.json(rows);
      } catch (error) {
...
var routes;
var init_functionsRoutes_0_251086712123578 = __esm({
  "../.wrangler/tmp/pages-J3es4s/functionsRoutes-0.251086712123578.mjs"() {
    init_route();
    routes = [
      {
        routePath: "/api/:route*",
...
// .wrangler/tmp/bundle-zsYgYg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-zsYgYg/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.00806614536230077.js.map
