...
// .wrangler/tmp/pages-IYexf8/functionsWorker-0.11798723323091775.mjs
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_3026073028562484();
...
var init_dashboard = __esm({
  "api/routers/dashboard.ts"() {
    ...
    dashboardRouter.get("/stats", async (c) => {
      ...
      const [revenueResult] = await db.select({ total: sql`sum(total_amount)` }).from(orders).where(and(
      ...
      const monthlyRevenue = await db.select({
        ...
        from ? gte(orders.createdAt, from) : void 0,
        to ? lte(orders.createdAt, to) : void 0
      )).groupBy(sql`strftime('%Y-%m', datetime(created_at, 'unixepoch'))`).orderBy(sql`strftime('%Y-%m', datetime(created_at, 'unixepoch'))`);
...
var init_bulk = __esm({
  "api/routers/bulk.ts"() {
    ...
    bulkRouter.get("/home", async (c) => {
      const db = c.get("db");
      try {
        const cached = await getCachedResponse("home_bulk");
        if (cached) {
          return c.json({
            ...cached,
            _cached: true,
...
var routes;
var init_functionsRoutes_0_3026073028562484 = __esm({
  "../.wrangler/tmp/pages-IYexf8/functionsRoutes-0.3026073028562484.mjs"() {
    init_app();
    init_route();
    init_slug();
    routes = [
...
// .wrangler/tmp/bundle-tyrmer/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tyrmer/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.11798723323091775.js.map
