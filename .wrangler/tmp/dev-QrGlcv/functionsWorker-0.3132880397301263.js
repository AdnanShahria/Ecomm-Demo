...
// .wrangler/tmp/pages-7Cdnxq/functionsWorker-0.3132880397301263.mjs
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_847342800141003();
...
var init_app = __esm({
  "api/app.ts"() {
    ...
    v1.use("*", async (c, next) => {
      ...
      const isReadOnly = c.env.DB_READ_ONLY === "true" || c.env.DB_READ_ONLY === "1";
      if (isReadOnly) {
        const isPublic2 = publicPaths.some((p) => path.startsWith(p));
        if (!isPublic2) {
          return c.json({
            error: "Forbidden",
            message: "Admin modifications are disabled in Demo Mode."
          }, 403);
        }
      }
...
var routes;
var init_functionsRoutes_0_847342800141003 = __esm({
  "../.wrangler/tmp/pages-7Cdnxq/functionsRoutes-0.847342800141003.mjs"() {
    init_app();
    init_route();
    init_slug();
    routes = [
...
// .wrangler/tmp/bundle-tV8P08/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tV8P08/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3132880397301263.js.map
