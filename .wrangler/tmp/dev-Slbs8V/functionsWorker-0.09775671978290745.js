...
// .wrangler/tmp/pages-V0rJf4/functionsWorker-0.09775671978290745.mjs
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_2621827146034086();
  ...
  "api/routers/products.ts"() {
    ...
    productsRouter.get("/by-slug/:slug/bulk", async (c) => {
      try {
        ...
        const candidates = await db.query.products.findMany({
          where: and(
            ...
            or(
              ...
              ...productTags.map((tag) => like(products.tags, `%"${tag}"%`))
            )
          ),
          limit: 30
        });
        const [reviews2, allApproved] = await Promise.all([
          ...
          db.select().from(reviews).where(and(eq(reviews.productId, product.id), eq(reviews.status, "approved")))
        ]);
        ...
        if (currentUserId) {
          const deliveredOrders = await db.select().from(orders).innerJoin(orderItems, eq(orders.id, orderItems.orderId)).where(and(
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          where: /* @__PURE__ */ __name2((o, { eq: eq2, and: and4 }) => {
            const filters = [];
  ...
  "api/routers/returns.ts"() {
    ...
    returnsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.returns.findMany({
        where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and4 }) => {
          const conditions = [];
          if (userId) conditions.push(eq2(r.userId, userId));
          if (type) conditions.push(eq2(r.type, type));
          return conditions.length > 1 ? and4(...conditions) : conditions[0];
        }, "where"),
...
var init_dashboard = __esm({
  "api/routers/dashboard.ts"() {
    ...
    dashboardRouter.get("/stats", async (c) => {
      ...
      const [totalRevenue] = await db.select({ total: sql`sum(total_amount)` }).from(orders);
      const growth = {
        revenue: "+12.5%",
        users: "+8.2%",
        orders: "+15.0%"
      ...
      try {
        const [
          ...
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and4 }) => and4(eq2(r.userId, userId), eq2(r.type, "return")), "where"),
            orderBy: /* @__PURE__ */ __name2((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
          }),
          // 6. Cancellations
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and4 }) => and4(eq2(r.userId, userId), eq2(r.type, "cancellation")), "where"),
            orderBy: /* @__PURE__ */ __name2((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
          }),
          // 7. Reviews
          ...
          db.query.notifications.findMany({
            where: /* @__PURE__ */ __name2((n, { eq: eq2, and: and4, or: or3, isNull: isNull3 }) => and4(
              eq2(n.isRead, 0),
              or3(eq2(n.userId, userId), isNull3(n.userId))
            ), "where")
          })
        ]);
        return c.json({
    ...
    systemRouter.post("/refresh-cache", async (c) => {
      ...
      try {
        const [banners2, categories2, newProducts, popularProducts] = await Promise.all([
          ...
          db.query.products.findMany({ limit: 8, orderBy: /* @__PURE__ */ __name2((p, { desc: desc7 }) => [desc7(p.createdAt)], "orderBy") }),
          db.query.products.findMany({ limit: 8, orderBy: /* @__PURE__ */ __name2((p, { desc: desc7 }) => [desc7(p.soldCount)], "orderBy") })
        ]);
...
var init_app = __esm({
  "api/app.ts"() {
    ...
    app.get("/api/health", async (c) => {
      ...
      if (db) {
        try {
          const res = await db.select({ count: orders.id }).from(orders);
          ordersCount = res.length;
        } catch (e) {
          error = e.message;
        }
      }
      return c.json({ status: "ok", version: "v1.mod" });
    });
    app.onError((err, c) => {
...
var routes;
var init_functionsRoutes_0_2621827146034086 = __esm({
  "../.wrangler/tmp/pages-V0rJf4/functionsRoutes-0.2621827146034086.mjs"() {
    init_app();
    init_route();
    init_slug();
    routes = [
...
// .wrangler/tmp/bundle-cKiCKY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-cKiCKY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.09775671978290745.js.map
