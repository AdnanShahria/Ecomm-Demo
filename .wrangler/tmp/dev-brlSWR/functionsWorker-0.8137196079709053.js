...
// .wrangler/tmp/pages-KxqVTa/functionsWorker-0.8137196079709053.mjs
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_6559001376980259();
...
var init_base64 = __esm({
  "../node_modules/js-base64/base64.mjs"() {
    ...
    atobPolyfill = /* @__PURE__ */ __name2((asc3) => {
  ...
  "api/[[route]].ts"() {
    ...
    app.use("*", async (c, next) => {
      ...
      try {
        ...
        c.set("db", drizzle(client, { schema: schema_exports }));
        await next();
      } catch (error) {
    ...
    app.onError((err, c) => {
      ...
      return c.json({
        ...
        details: true ? err.message : void 0,
        timestamp: (/* @__PURE__ */ new Date()).toISOString(),
        path: c.req.path
      }, 500);
    });
      ...
      try {
        const [
          ...
          db.query.banners.findMany({
            where: /* @__PURE__ */ __name2((b, { eq: eq2 }) => eq2(b.position, "hero"), "where"),
            orderBy: /* @__PURE__ */ __name2((b, { asc: asc3 }) => [asc3(b.order)], "orderBy")
          }),
          db.query.banners.findMany({
            where: /* @__PURE__ */ __name2((b, { eq: eq2 }) => eq2(b.position, "mid-1"), "where"),
            orderBy: /* @__PURE__ */ __name2((b, { asc: asc3 }) => [asc3(b.order)], "orderBy")
          }),
          db.query.banners.findMany({
            where: /* @__PURE__ */ __name2((b, { eq: eq2 }) => eq2(b.position, "mid-2"), "where"),
            orderBy: /* @__PURE__ */ __name2((b, { asc: asc3 }) => [asc3(b.order)], "orderBy")
          }),
          db.query.categories.findMany({
            where: /* @__PURE__ */ __name2((cat, { eq: eq2 }) => eq2(cat.isActive, 1), "where")
          }),
          db.query.products.findMany({
            limit: 10,
            orderBy: /* @__PURE__ */ __name2((p, { desc: desc2 }) => [desc2(p.rating)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 8,
            where: /* @__PURE__ */ __name2((p, { like: like2 }) => like2(p.tags, '%"new-arrival"%'), "where"),
            orderBy: /* @__PURE__ */ __name2((p, { desc: desc2 }) => [desc2(p.createdAt)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 4,
            where: /* @__PURE__ */ __name2((p, { and: and2, isNotNull: isNotNull2, like: like2 }) => and2(isNotNull2(p.salePrice), like2(p.tags, '%"special-offer"%')), "where")
          }),
          db.query.products.findMany({
            limit: 8,
            where: /* @__PURE__ */ __name2((p, { like: like2 }) => like2(p.tags, '%"best-selling"%'), "where"),
            orderBy: /* @__PURE__ */ __name2((p, { desc: desc2 }) => [desc2(p.soldCount)], "orderBy")
          }),
          db.query.notifications.findMany({
            where: /* @__PURE__ */ __name2((n, { isNull: isNull2 }) => isNull2(n.userId), "where"),
            limit: 5,
            orderBy: /* @__PURE__ */ __name2((n, { desc: desc2 }) => [desc2(n.createdAt)], "orderBy")
          })
        ]);
        return c.json({
          banners: {
          ...
          notifications: { items: notifications2 },
          timestamp: (/* @__PURE__ */ new Date()).toISOString()
        });
      } catch (error) {
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.products.findMany({
          ...
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name2((p, { desc: desc2, asc: asc3 }) => {
            if (sort === "newest") return [desc2(p.createdAt)];
            if (sort === "price-low") return [asc3(p.price)];
            if (sort === "price-high") return [desc2(p.price)];
            if (sort === "best-selling") return [desc2(p.soldCount)];
            if (sort === "trending") return [desc2(p.rating)];
            return [desc2(p.createdAt)];
          }, "orderBy")
        });
    ...
    productsRouter.get("/search", async (c) => {
      try {
        ...
        const db = c.get("db");
        const rows = await db.query.products.findMany({
          where: /* @__PURE__ */ __name2((p, { like: like2, or: or2 }) => or2(
            like2(p.title, `%${q}%`),
            like2(p.brand, `%${q}%`)
          ), "where"),
          limit: 10
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          where: customerName ? (o, { eq: eq2 }) => eq2(o.customerName, customerName) : void 0,
          orderBy: /* @__PURE__ */ __name2((o, { desc: desc2 }) => [desc2(o.createdAt)], "orderBy")
        });
        return c.json({
    ...
    ordersRouter.post("/:id/cancel", async (c) => {
      ...
      const orderItems2 = await db.select().from(orderItems).where(eq(orderItems.orderId, id));
    ...
    authRouter.post("/register", async (c) => {
      ...
      return c.json({
        id,
        username: body.username,
        message: body.email ? "Account created! Check your email for the verification code." : "Account created successfully.",
    ...
    addressesRouter.get("/", async (c) => {
      ...
      const rows = await db.query.addresses.findMany({
        ...
        orderBy: /* @__PURE__ */ __name2((a, { desc: desc2 }) => [desc2(a.isDefault), desc2(a.createdAt)], "orderBy")
      });
      return c.json({
    ...
    reviewsRouter.get("/", async (c) => {
      ...
      let whereClause;
      if (productId) {
        whereClause = /* @__PURE__ */ __name2((r, { eq: eq2 }) => eq2(r.productId, productId), "whereClause");
      } else if (userId) {
        whereClause = /* @__PURE__ */ __name2((r, { eq: eq2 }) => eq2(r.userId, userId), "whereClause");
      }
      const rows = await db.query.reviews.findMany({
        where: /* @__PURE__ */ __name2((r, { and: and2, eq: eq2 }) => {
          const conds = [];
          if (productId) conds.push(eq2(r.productId, productId));
          if (userId) conds.push(eq2(r.userId, userId));
          if (productId && !userId) conds.push(eq2(r.status, "approved"));
          return conds.length > 1 ? and2(...conds) : conds[0];
        }, "where"),
        orderBy: /* @__PURE__ */ __name2((r, { desc: desc2 }) => [desc2(r.createdAt)], "orderBy")
      });
      let stats = null;
      if (productId) {
        ...
        if (approvedRows.length > 0) {
          ...
          const avgRating = approvedRows.reduce((sum, r) => sum + r.rating, 0) / total;
          const distribution = [1, 2, 3, 4, 5].map((star) => ({
            stars: star,
            count: approvedRows.filter((r) => r.rating === star).length,
            percentage: Math.round(approvedRows.filter((r) => r.rating === star).length / total * 100)
          }));
    ...
    reviewsRouter.post("/", async (c) => {
      ...
      const existingReviews = await db.select().from(reviews).where(and(
        eq(reviews.productId, body.productId),
        eq(reviews.userId, body.userId)
      ));
      ...
      let isVerified = 0;
      try {
        const userOrders = await db.select().from(orders).where(eq(orders.userId, body.userId));
      ...
      const allReviews = await db.select().from(reviews).where(eq(reviews.productId, body.productId));
    ...
    reviewsRouter.patch("/:id", async (c) => {
      ...
      const updates = {};
      if (body.rating !== void 0) updates.rating = body.rating;
      if (body.title !== void 0) updates.title = body.title;
      if (body.content !== void 0) updates.content = body.content;
      if (body.images !== void 0) updates.images = JSON.stringify(body.images);
      if (body.status !== void 0) updates.status = body.status;
      if (Object.keys(updates).length > 0) {
        await db.update(reviews).set(updates).where(eq(reviews.id, id));
      }
      if (body.rating !== void 0 || body.status !== void 0) {
        const approvedReviews = await db.select().from(reviews).where(and(
          eq(reviews.productId, existing.productId),
    ...
    reviewsRouter.delete("/:id", async (c) => {
      ...
      const remaining = await db.select().from(reviews).where(eq(reviews.productId, existing.productId));
      const avgRating = remaining.length > 0 ? remaining.reduce((sum, r) => sum + r.rating, 0) / remaining.length : 0;
      await db.update(products).set({
        rating: Math.round(avgRating * 10) / 10,
    ...
    returnsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.returns.findMany({
        where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and2 }) => {
          const conditions = [];
          if (userId) conditions.push(eq2(r.userId, userId));
          if (type) conditions.push(eq2(r.type, type));
          return conditions.length > 1 ? and2(...conditions) : conditions[0];
        }, "where"),
        orderBy: /* @__PURE__ */ __name2((r, { desc: desc2 }) => [desc2(r.createdAt)], "orderBy")
      });
      return c.json({
    ...
    couponsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.coupons.findMany({
        orderBy: /* @__PURE__ */ __name2((cp, { desc: desc2 }) => [desc2(cp.createdAt)], "orderBy")
      });
      return c.json({
    ...
    dashboardRouter.get("/stats", async (c) => {
      ...
      }).from(orders).where(sql`lower(status) != 'cancelled'`);
      ...
      statusRows.forEach((r) => {
        ordersByStatus[r.status || "Unknown"] = r.count;
      });
      ...
      }).from(products).where(sql`stock < COALESCE(low_stock_threshold, 5) AND is_active = 1`).limit(10);
      const monthlyRevenue = await db.select({
        month: sql`strftime('%Y-%m', datetime(created_at, 'unixepoch'))`,
        total: sql`COALESCE(SUM(total_amount), 0)`,
        count: sql`count(*)`
      }).from(orders).where(sql`lower(status) != 'cancelled'`).groupBy(sql`strftime('%Y-%m', datetime(created_at, 'unixepoch'))`).orderBy(sql`strftime('%Y-%m', datetime(created_at, 'unixepoch')) DESC`).limit(6);
      return c.json({
        counts: {
    ...
    walletRouter.get("/", async (c) => {
      ...
      const rows = await db.query.walletTransactions.findMany({
        ...
        orderBy: /* @__PURE__ */ __name2((t, { desc: desc2 }) => [desc2(t.createdAt)], "orderBy")
      });
    ...
    notificationsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.notifications.findMany({
          where: userId ? or(eq(notifications.userId, userId), isNull(notifications.userId)) : isNull(notifications.userId),
          orderBy: /* @__PURE__ */ __name2((n, { desc: desc2 }) => [desc2(n.createdAt)], "orderBy")
        });
...
var routes;
var init_functionsRoutes_0_6559001376980259 = __esm({
  "../.wrangler/tmp/pages-KxqVTa/functionsRoutes-0.6559001376980259.mjs"() {
    init_route();
    init_slug();
    routes = [
      {
...
// .wrangler/tmp/bundle-kX10aI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kX10aI/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8137196079709053.js.map
