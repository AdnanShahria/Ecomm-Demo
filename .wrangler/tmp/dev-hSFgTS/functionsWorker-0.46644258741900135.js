...
// .wrangler/tmp/pages-FMGuOX/functionsWorker-0.46644258741900135.mjs
...
var __copyProps = /* @__PURE__ */ __name((to, from, except2, desc7) => {
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key of __getOwnPropNames(from))
      if (!__hasOwnProp.call(to, key) && key !== except2)
        __defProp2(to, key, { get: /* @__PURE__ */ __name(() => from[key], "get"), enumerable: !(desc7 = __getOwnPropDesc(from, key)) || desc7.enumerable });
  }
  return to;
}, "__copyProps");
...
var init_compose = __esm({
  "../node_modules/hono/dist/compose.js"() {
    init_functionsRoutes_0_3546270204857923();
...
var init_base64 = __esm({
  "../node_modules/js-base64/base64.mjs"() {
    ...
    atobPolyfill = /* @__PURE__ */ __name2((asc2) => {
...
var LibSQLSession;
var LibSQLTransaction;
var LibSQLPreparedQuery;
var init_session2 = __esm({
  "../node_modules/drizzle-orm/libsql/session.js"() {
    ...
    LibSQLSession = class _LibSQLSession extends SQLiteSession {
      static {
        __name(this, "_LibSQLSession");
      }
      static {
        __name2(this, "LibSQLSession");
      }
    ...
    LibSQLTransaction = class _LibSQLTransaction extends SQLiteTransaction {
      static {
        __name(this, "_LibSQLTransaction");
      }
      static {
        __name2(this, "LibSQLTransaction");
      }
    ...
    LibSQLPreparedQuery = class extends SQLitePreparedQuery {
      ...
      static {
        __name2(this, "LibSQLPreparedQuery");
      }
    ...
    __name2(normalizeFieldValue, "normalizeFieldValue");
  }
});
...
var trackings;
var ordersRelations;
var orderItemsRelations;
var trackingsRelations;
...
__export(schema_exports, {
  addresses: /* @__PURE__ */ __name(() => addresses, "addresses"),
  adminLogs: /* @__PURE__ */ __name(() => adminLogs, "adminLogs"),
  banners: /* @__PURE__ */ __name(() => banners, "banners"),
  categories: /* @__PURE__ */ __name(() => categories, "categories"),
  coupons: /* @__PURE__ */ __name(() => coupons, "coupons"),
  newsletterLeads: /* @__PURE__ */ __name(() => newsletterLeads, "newsletterLeads"),
  notifications: /* @__PURE__ */ __name(() => notifications, "notifications"),
  ...
  otpCodes: /* @__PURE__ */ __name(() => otpCodes, "otpCodes"),
  popupSettings: /* @__PURE__ */ __name(() => popupSettings, "popupSettings"),
  productSales: /* @__PURE__ */ __name(() => productSales, "productSales"),
  productSimilarity: /* @__PURE__ */ __name(() => productSimilarity, "productSimilarity"),
  products: /* @__PURE__ */ __name(() => products, "products"),
  returns: /* @__PURE__ */ __name(() => returns, "returns"),
  reviews: /* @__PURE__ */ __name(() => reviews, "reviews"),
  systemCache: /* @__PURE__ */ __name(() => systemCache, "systemCache"),
  systemSettings: /* @__PURE__ */ __name(() => systemSettings, "systemSettings"),
  trackings: /* @__PURE__ */ __name(() => trackings, "trackings"),
  trackingsRelations: /* @__PURE__ */ __name(() => trackingsRelations, "trackingsRelations"),
  userInteractions: /* @__PURE__ */ __name(() => userInteractions, "userInteractions"),
  users: /* @__PURE__ */ __name(() => users, "users"),
  walletTransactions: /* @__PURE__ */ __name(() => walletTransactions, "walletTransactions")
});
...
var init_jwt = __esm({
  "../node_modules/hono/dist/utils/jwt/jwt.js"() {
    ...
    decode2 = /* @__PURE__ */ __name2((token) => {
...
var formatLinks;
var createPaginatedResponse;
var invalidateHomeCache;
var fetchHomeBulkData;
var init_helpers = __esm({
  "api/utils/helpers.ts"() {
    "use strict";
    init_functionsRoutes_0_3546270204857923();
    init_drizzle_orm();
    formatLinks = /* @__PURE__ */ __name2((c, path, id) => {
    ...
    createPaginatedResponse = /* @__PURE__ */ __name2((items, total, page, limit, links) => {
    ...
    invalidateHomeCache = /* @__PURE__ */ __name2(async (db, schema) => {
      try {
    ...
    fetchHomeBulkData = /* @__PURE__ */ __name2(async (db, schema) => {
      const [banners2, categories2, newProducts, popularProducts, bestSelling, [popup]] = await Promise.all([
        ...
        db.query.products.findMany({
          where: /* @__PURE__ */ __name2((p, { eq: eq2 }) => eq2(p.isActive, 1), "where"),
          limit: 8,
          orderBy: /* @__PURE__ */ __name2((p, { desc: desc7 }) => [desc7(p.createdAt)], "orderBy")
        }),
        db.query.products.findMany({
          where: /* @__PURE__ */ __name2((p, { eq: eq2 }) => eq2(p.isActive, 1), "where"),
          limit: 8,
          orderBy: /* @__PURE__ */ __name2((p, { desc: desc7 }) => [desc7(p.rating)], "orderBy")
        }),
        db.query.products.findMany({
          where: /* @__PURE__ */ __name2((p, { eq: eq2 }) => eq2(p.isActive, 1), "where"),
          limit: 8,
          orderBy: /* @__PURE__ */ __name2((p, { desc: desc7 }) => [desc7(p.soldCount)], "orderBy")
        }),
        db.select().from(schema.popupSettings).where(eq(schema.popupSettings.isActive, 1)).limit(1)
      ]);
      const normalizePosition = /* @__PURE__ */ __name2((p) => p?.toLowerCase().trim() || "", "normalizePosition");
      return {
        banners: {
          hero: banners2.filter((b) => normalizePosition(b.position) === "hero").sort((a, b) => (a.order ?? 0) - (b.order ?? 0)),
          mid1: banners2.filter((b) => normalizePosition(b.position) === "mid-1").sort((a, b) => (a.order ?? 0) - (b.order ?? 0)),
          mid2: banners2.filter((b) => normalizePosition(b.position) === "mid-2").sort((a, b) => (a.order ?? 0) - (b.order ?? 0))
        },
  ...
  try {
    const res = await fetch(scriptUrl, {
      ...
      body: JSON.stringify({
        ...
        isHtml: !!payload.html,
        senderName: payload.senderName || "Aurelia"
      })
    });
    if (!res.ok) {
  ...
  return `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #fff; border-radius: 16px; border: 1px solid #eee;">
      <div style="text-align: center; margin-bottom: 24px;">
        <h1 style="color: #1a1a2e; font-size: 24px; margin: 0;">\u{1F3E0} Aurelia</h1>
...
function orderConfirmationEmailHtml(invoiceId, customerName, totalAmount, items) {
  ...
  return `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 520px; margin: 0 auto; padding: 32px; background: #fff; border-radius: 16px; border: 1px solid #eee;">
      ...
      <hr style="border: none; border-top: 1px solid #eee; margin: 24px 0;" />
      <p style="color: #aaa; font-size: 11px; text-align: center;">Thank you for shopping with Aurelia!</p>
    </div>
  `;
}
...
function adminNewOrderEmailHtml(invoiceId, customerName, totalAmount, itemCount) {
  return `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #fff; border-radius: 16px; border: 2px solid #f59e0b;">
      <div style="text-align: center; margin-bottom: 24px;">
        <h1 style="color: #1a1a2e; font-size: 24px; margin: 0;">\u{1F3E0} Aurelia \u2014 Admin</h1>
...
var init_email = __esm({
  "api/utils/email.ts"() {
    ...
    __name2(otpEmailHtml, "otpEmailHtml");
    __name2(passwordResetEmailHtml, "passwordResetEmailHtml");
    __name2(orderConfirmationEmailHtml, "orderConfirmationEmailHtml");
    __name2(adminNewOrderEmailHtml, "adminNewOrderEmailHtml");
    __name2(orderStatusUpdateEmailHtml, "orderStatusUpdateEmailHtml");
  }
});
...
var init_auth = __esm({
  "api/routers/auth.ts"() {
    ...
    authRouter.post("/register", async (c) => {
      ...
      const encoder = new TextEncoder();
      const data = encoder.encode(body.password + "aurelia-salt-2026");
      const hashBuffer = await crypto.subtle.digest("SHA-256", data);
    ...
    authRouter.post("/admin-login", async (c) => {
      ...
      if (!expectedUsername || !expectedPassword) {
        return c.json({ error: "InternalServerError", message: "Admin credentials not configured on the server." }, 500);
      }
    ...
    authRouter.post("/resend-otp", async (c) => {
      ...
      if (email) {
        const resendOtpPromise = sendEmail(c.env.GOOGLE_SCRIPT_URL, c.env.EMAIL_WEBHOOK_SECRET, {
          to: email,
          subject: "Aurelia \u2014 Your Verification Code",
    ...
    authRouter.post("/forgot-password", async (c) => {
      ...
      const forgotPasswordPromise = sendEmail(c.env.GOOGLE_SCRIPT_URL, c.env.EMAIL_WEBHOOK_SECRET, {
        to: user.email,
        subject: "Aurelia \u2014 Password Reset Code",
    ...
    authRouter.post("/reset-password", async (c) => {
      ...
      const encoder = new TextEncoder();
      const data = encoder.encode(body.newPassword + "aurelia-salt-2026");
      const hashBuffer = await crypto.subtle.digest("SHA-256", data);
      const hashArray = Array.from(new Uint8Array(hashBuffer));
      const passwordHash = hashArray.map((b) => b.toString(16).padStart(2, "0")).join("");
...
var init_users2 = __esm({
  "api/routers/users.ts"() {
    ...
    usersRouter.patch("/:id/password", async (c) => {
      ...
      if (!user) throw new Error(`User with ID ${id} not found`);
      const encoder = new TextEncoder();
      const currentData = encoder.encode(body.currentPassword + "aurelia-salt-2026");
      ...
      const newData = encoder.encode(body.newPassword + "aurelia-salt-2026");
  ...
  "api/routers/products.ts"() {
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.products.findMany({
          ...
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name2((p, { desc: desc7, asc: asc2 }) => {
    ...
    productsRouter.get("/search", async (c) => {
      try {
        ...
        const db = c.get("db");
        const rows = await db.query.products.findMany({
          where: /* @__PURE__ */ __name2((p, { like: like2, or: or3 }) => or3(
            like2(p.title, `%${q}%`),
            like2(p.brand, `%${q}%`)
          ), "where"),
          limit: 10
    ...
    categoriesRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.categories.findMany({
          where: /* @__PURE__ */ __name2((cat, { eq: eq2, and: and3 }) => {
    ...
    bannersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.banners.findMany({
          ...
          orderBy: /* @__PURE__ */ __name2((b, { asc: asc2 }) => [asc2(b.order)], "orderBy")
        });
        return c.json({
          items: rows.map((r) => ({
            ...r,
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          where: /* @__PURE__ */ __name2((o, { eq: eq2, and: and3 }) => {
            const filters = [];
          ...
          orderBy: /* @__PURE__ */ __name2((o, { desc: desc7 }) => [desc7(o.createdAt)], "orderBy")
        });
        return c.json({
          items: rows.map((r) => ({
            ...r,
    ...
    ordersRouter.post("/", async (c) => {
      ...
      if (body.customerEmail && c.env.GOOGLE_SCRIPT_URL) {
        ...
        const customerEmailPromise = sendEmail(c.env.GOOGLE_SCRIPT_URL, c.env.EMAIL_WEBHOOK_SECRET, {
          ...
          subject: `Aurelia \u2014 Order Confirmed (${invoiceId})`,
    ...
    ordersRouter.patch("/:id/status", async (c) => {
      ...
      if (existing.customerEmail && c.env.GOOGLE_SCRIPT_URL && newStatus !== existing.status) {
        const statusUpdatePromise = sendEmail(c.env.GOOGLE_SCRIPT_URL, c.env.EMAIL_WEBHOOK_SECRET, {
          ...
          subject: `Aurelia \u2014 Order ${existing.invoiceId} is now "${newStatus}"`,
    ...
    ordersRouter.post("/:id/trackings", async (c) => {
      ...
      if (existing.customerEmail && c.env.GOOGLE_SCRIPT_URL) {
        const trackingUpdatePromise = sendEmail(c.env.GOOGLE_SCRIPT_URL, c.env.EMAIL_WEBHOOK_SECRET, {
          to: existing.customerEmail,
          subject: `Aurelia \u2014 Tracking Update for ${existing.invoiceId}`,
    ...
    ordersRouter.post("/:id/cancel", async (c) => {
      ...
      if (order.customerEmail && c.env.GOOGLE_SCRIPT_URL) {
        const cancellationPromise = sendEmail(c.env.GOOGLE_SCRIPT_URL, c.env.EMAIL_WEBHOOK_SECRET, {
          ...
          subject: `Aurelia \u2014 Order ${order.invoiceId} Cancelled`,
  ...
  "api/routers/addresses.ts"() {
    ...
    addressesRouter.get("/", async (c) => {
      ...
      const rows = await db.query.addresses.findMany({
        where: /* @__PURE__ */ __name2((a, { eq: eq2 }) => eq2(a.userId, userId), "where"),
        orderBy: /* @__PURE__ */ __name2((a, { desc: desc7 }) => [desc7(a.isDefault), desc7(a.createdAt)], "orderBy")
      });
      return c.json({
  ...
  "api/routers/returns.ts"() {
    ...
    returnsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.returns.findMany({
        where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and3 }) => {
          const conditions = [];
        ...
        orderBy: /* @__PURE__ */ __name2((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
      });
      return c.json({
    ...
    settingsRouter.post("/test-email", async (c) => {
      ...
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #fff; border-radius: 16px; border: 2px solid #22c55e;">
        <div style="text-align: center;">
          <h1 style="color: #1a1a2e; font-size: 24px; margin: 0;">Aurelia</h1>
  ...
  "api/routers/coupons.ts"() {
    ...
    couponsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.coupons.findMany({
        orderBy: /* @__PURE__ */ __name2((cp, { desc: desc7 }) => [desc7(cp.createdAt)], "orderBy")
      });
      return c.json({
  ...
  "api/routers/dashboard.ts"() {
    ...
    dashboardRouter.get("/stats", async (c) => {
      ...
      const dateFilter = and(
        from ? gte(orders.createdAt, from) : void 0,
        to ? lte(orders.createdAt, to) : void 0
      );
      const [
        [prodCount],
        [catCount],
        ...
        db.select({ total: sql`sum(quantity)` }).from(orderItems),
        // 2. Revenue calculation with date filtering
        db.select({ total: sql`sum(total_amount)` }).from(orders).where(dateFilter),
        // 3. Orders by status
        db.select({
          status: orders.status,
          count: sql`count(*)`
        }).from(orders).where(dateFilter).groupBy(orders.status),
        // 4. Monthly Revenue
        db.select({
          month: sql`strftime('%Y-%m', datetime(created_at, 'unixepoch'))`,
          total: sql`sum(total_amount)`,
          count: sql`count(*)`
        }).from(orders).where(dateFilter).groupBy(sql`strftime('%Y-%m', datetime(created_at, 'unixepoch'))`).orderBy(sql`strftime('%Y-%m', datetime(created_at, 'unixepoch'))`),
        // 5. Recent Orders
        db.select({
          id: orders.id,
  ...
  "api/routers/wallet.ts"() {
    ...
    walletRouter.get("/", async (c) => {
      ...
      const rows = await db.query.walletTransactions.findMany({
        where: /* @__PURE__ */ __name2((t, { eq: eq2 }) => eq2(t.userId, userId), "where"),
        orderBy: /* @__PURE__ */ __name2((t, { desc: desc7 }) => [desc7(t.createdAt)], "orderBy")
      });
    ...
    notificationsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.notifications.findMany({
          ...
          orderBy: /* @__PURE__ */ __name2((n, { desc: desc7 }) => [desc7(n.createdAt)], "orderBy")
        });
...
var CACHE_NAME;
var buildCacheKey;
var getCachedResponse;
var setCachedResponse;
var invalidateCache;
var init_cache3 = __esm({
  "api/utils/cache.ts"() {
    "use strict";
    init_functionsRoutes_0_3546270204857923();
    CACHE_NAME = "aurelia-super-cache";
    buildCacheKey = /* @__PURE__ */ __name2((key) => new Request(`https://super-cache.local/${key}`), "buildCacheKey");
    getCachedResponse = /* @__PURE__ */ __name2(async (key) => {
      try {
    ...
    setCachedResponse = /* @__PURE__ */ __name2(async (c, key, data, ttlSeconds = 3600) => {
      try {
        const cache = await caches.open(CACHE_NAME);
    ...
    invalidateCache = /* @__PURE__ */ __name2(async (key) => {
      try {
        const cache = await caches.open(CACHE_NAME);
  ...
  "api/routers/bulk.ts"() {
      ...
      try {
        const [
          ...
          db.query.users.findFirst({
            where: /* @__PURE__ */ __name2((u, { eq: eq2 }) => eq2(u.id, userId), "where")
          }),
          ...
          db.query.addresses.findMany({
            where: /* @__PURE__ */ __name2((a, { eq: eq2 }) => eq2(a.userId, userId), "where"),
            orderBy: /* @__PURE__ */ __name2((a, { desc: desc7 }) => [desc7(a.createdAt)], "orderBy")
          }),
          // 4. Orders (Unified query for registered & guest checkouts)
          db.query.orders.findMany({
            where: /* @__PURE__ */ __name2((o, { eq: eq2, or: or3 }) => {
              const conds = [];
          ...
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and3 }) => and3(eq2(r.userId, userId), eq2(r.type, "return")), "where"),
            orderBy: /* @__PURE__ */ __name2((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
          }),
          // 6. Cancellations
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name2((r, { eq: eq2, and: and3 }) => and3(eq2(r.userId, userId), eq2(r.type, "cancellation")), "where"),
            orderBy: /* @__PURE__ */ __name2((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
          }),
          // 7. Reviews
          db.query.reviews.findMany({
            where: /* @__PURE__ */ __name2((r, { eq: eq2 }) => eq2(r.userId, userId), "where"),
            orderBy: /* @__PURE__ */ __name2((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
          }),
          // 8. Unread Notifications Count
          db.query.notifications.findMany({
            where: /* @__PURE__ */ __name2((n, { eq: eq2, and: and3, or: or3, isNull: isNull2 }) => and3(
              eq2(n.isRead, 0),
    ...
    bulkRouter.get("/home", async (c) => {
      ...
      try {
        ...
        const [dbCached] = await db.select().from(systemCache).where(eq(systemCache.key, "home_bulk"));
        if (dbCached) {
          const age = Date.now() - new Date(dbCached.updatedAt).getTime();
          if (age < HOME_CACHE_TTL_MS) {
            const cachedData = JSON.parse(dbCached.data);
            return c.json({
              ...cachedData,
              _cached: true,
              _cacheType: "d1_database"
            });
          }
        }
        const structuredData = await fetchHomeBulkData(db, schema_exports);
        const responseData = { ...structuredData, _cached: false, _cacheType: "none" };
        const isReadOnly = c.env.DB_READ_ONLY === "true" || c.env.DB_READ_ONLY === "1";
        if (!isReadOnly) {
          ...
          await db.insert(systemCache).values({
            ...
            target: systemCache.key,
            set: { data: JSON.stringify(responseData), updatedAt: /* @__PURE__ */ new Date() }
          });
        }
  ...
  "api/routers/system.ts"() {
    ...
    systemRouter.post("/refresh-cache", async (c) => {
      ...
      try {
        ...
        await db.delete(systemCache).where(eq(systemCache.key, "home_bulk"));
  ...
  "product/[[slug]].ts"() {
    ...
    onRequest2 = /* @__PURE__ */ __name2(async (context) => {
      ...
      try {
        ...
        const metaTags = `
      <title>${product.title} | Aurelia</title>
      <meta name="description" content="${product.brand || "Premium Baby Playpen"}">
      <meta property="og:title" content="${product.title}">
      <meta property="og:description" content="Get the best ${product.title} for your baby at Aurelia.">
...
var routes;
var init_functionsRoutes_0_3546270204857923 = __esm({
  "../.wrangler/tmp/pages-FMGuOX/functionsRoutes-0.3546270204857923.mjs"() {
    init_app();
    init_route();
    init_slug();
    routes = [
...
// .wrangler/tmp/bundle-JA0YqC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JA0YqC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.46644258741900135.js.map
