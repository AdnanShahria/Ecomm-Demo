...
var formatLinks, createPaginatedResponse, invalidateHomeCache, fetchHomeBulkData;
var init_helpers = __esm({
  "api/utils/helpers.ts"() {
    ...
    fetchHomeBulkData = /* @__PURE__ */ __name(async (db, schema) => {
      ...
      const normalizePosition = /* @__PURE__ */ __name((p) => p?.toLowerCase().trim() || "", "normalizePosition");
      return {
        banners: {
...
// api/utils/cache.ts
var CACHE_NAME, buildCacheKey, getCachedResponse, setCachedResponse, invalidateCache;
var init_cache3 = __esm({
  "api/utils/cache.ts"() {
    "use strict";
    init_functionsRoutes_0_3546270204857923();
    CACHE_NAME = "aurelia-super-cache";
    buildCacheKey = /* @__PURE__ */ __name((key) => new Request(`https://super-cache.local/${key}`), "buildCacheKey");
    getCachedResponse = /* @__PURE__ */ __name(async (key) => {
      try {
    ...
    setCachedResponse = /* @__PURE__ */ __name(async (c, key, data, ttlSeconds = 3600) => {
      try {
        const cache = await caches.open(CACHE_NAME);
    ...
    invalidateCache = /* @__PURE__ */ __name(async (key) => {
      try {
        const cache = await caches.open(CACHE_NAME);
...
// api/routers/bulk.ts
var HOME_CACHE_TTL_MS, bulkRouter;
var init_bulk = __esm({
  "api/routers/bulk.ts"() {
    "use strict";
    init_functionsRoutes_0_3546270204857923();
...
// ../.wrangler/tmp/bundle-5ed806/middleware-loader.entry.ts
init_functionsRoutes_0_3546270204857923();

// ../.wrangler/tmp/bundle-5ed806/middleware-insertion-facade.js
init_functionsRoutes_0_3546270204857923();
...
//# sourceMappingURL=functionsWorker-0.46644258741900135.mjs.map
