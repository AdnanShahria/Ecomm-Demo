...
var banners, categories, products, orders, orderItems, trackings;
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.products.findMany({
          ...
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name((p, { desc: desc2, asc: asc2 }) => {
...
// ../.wrangler/tmp/bundle-14TwMn/middleware-loader.entry.ts
init_functionsRoutes_0_3028408687084557();

// ../.wrangler/tmp/bundle-14TwMn/middleware-insertion-facade.js
init_functionsRoutes_0_3028408687084557();
...
//# sourceMappingURL=functionsWorker-0.9604113104045023.mjs.map
