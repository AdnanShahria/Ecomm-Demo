...
var banners, categories, products;
  ...
  "api/[[route]].ts"() {
    ...
    app.get("/products/search", async (c) => {
      try {
        ...
        if (!db) return c.json([]);
        const rows = await db.query.products.findMany({
          where: /* @__PURE__ */ __name((p, { like: like2 }) => like2(p.title, `%${q}%`), "where"),
          limit: 5
        });
        return c.json(rows);
      } catch (error) {
...
// ../.wrangler/tmp/bundle-zNIgw4/middleware-loader.entry.ts
init_functionsRoutes_0_251086712123578();

// ../.wrangler/tmp/bundle-zNIgw4/middleware-insertion-facade.js
init_functionsRoutes_0_251086712123578();
...
//# sourceMappingURL=functionsWorker-0.00806614536230077.mjs.map
