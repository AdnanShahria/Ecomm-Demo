...
var init_base64 = __esm({
  "../node_modules/js-base64/base64.mjs"() {
    ...
    atobPolyfill = /* @__PURE__ */ __name((asc3) => {
...
var orders, orderItems, trackings;
...
var formatLinks, createPaginatedResponse, rateLimitMap, CLEANUP_INTERVAL, lastCleanup, app, globalRequestCount, apiStartTime, v1, bannersRouter, categoriesRouter, productsRouter, ordersRouter, authRouter, usersRouter, addressesRouter, reviewsRouter, returnsRouter, settingsRouter, couponsRouter, dashboardRouter, walletRouter, notificationsRouter, onRequest;
  ...
  "api/[[route]].ts"() {
      ...
      try {
        const [
          ...
          db.query.banners.findMany({
            where: /* @__PURE__ */ __name((b, { eq: eq2 }) => eq2(b.position, "hero"), "where"),
            orderBy: /* @__PURE__ */ __name((b, { asc: asc3 }) => [asc3(b.order)], "orderBy")
          }),
          db.query.banners.findMany({
            where: /* @__PURE__ */ __name((b, { eq: eq2 }) => eq2(b.position, "mid-1"), "where"),
            orderBy: /* @__PURE__ */ __name((b, { asc: asc3 }) => [asc3(b.order)], "orderBy")
          }),
          db.query.banners.findMany({
            where: /* @__PURE__ */ __name((b, { eq: eq2 }) => eq2(b.position, "mid-2"), "where"),
            orderBy: /* @__PURE__ */ __name((b, { asc: asc3 }) => [asc3(b.order)], "orderBy")
          }),
          db.query.categories.findMany({
            where: /* @__PURE__ */ __name((cat, { eq: eq2 }) => eq2(cat.isActive, 1), "where")
          }),
          db.query.products.findMany({
            limit: 10,
            orderBy: /* @__PURE__ */ __name((p, { desc: desc2 }) => [desc2(p.rating)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 8,
            where: /* @__PURE__ */ __name((p, { like: like2 }) => like2(p.tags, '%"new-arrival"%'), "where"),
            orderBy: /* @__PURE__ */ __name((p, { desc: desc2 }) => [desc2(p.createdAt)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 4,
            where: /* @__PURE__ */ __name((p, { and: and2, isNotNull: isNotNull2, like: like2 }) => and2(isNotNull2(p.salePrice), like2(p.tags, '%"special-offer"%')), "where")
          }),
          db.query.products.findMany({
            limit: 8,
            where: /* @__PURE__ */ __name((p, { like: like2 }) => like2(p.tags, '%"best-selling"%'), "where"),
            orderBy: /* @__PURE__ */ __name((p, { desc: desc2 }) => [desc2(p.soldCount)], "orderBy")
          }),
          db.query.notifications.findMany({
            where: /* @__PURE__ */ __name((n, { isNull: isNull2 }) => isNull2(n.userId), "where"),
            limit: 5,
    ...
    categoriesRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.categories.findMany({
          where: /* @__PURE__ */ __name((cat, { eq: eq2, and: and2 }) => {
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.products.findMany({
          ...
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name((p, { desc: desc2, asc: asc3 }) => {
    ...
    productsRouter.get("/search", async (c) => {
      try {
        ...
        const db = c.get("db");
        const rows = await db.query.products.findMany({
          where: /* @__PURE__ */ __name((p, { like: like2, or: or2 }) => or2(
            like2(p.title, `%${q}%`),
            like2(p.brand, `%${q}%`)
          ), "where"),
          limit: 10
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          ...
          orderBy: /* @__PURE__ */ __name((o, { desc: desc2 }) => [desc2(o.createdAt)], "orderBy")
        });
        return c.json({
    ...
    addressesRouter.get("/", async (c) => {
      ...
      const rows = await db.query.addresses.findMany({
        ...
        orderBy: /* @__PURE__ */ __name((a, { desc: desc2 }) => [desc2(a.isDefault), desc2(a.createdAt)], "orderBy")
      });
      return c.json({
    ...
    reviewsRouter.get("/", async (c) => {
      ...
      let whereClause;
      if (productId) {
        whereClause = /* @__PURE__ */ __name((r, { eq: eq2 }) => eq2(r.productId, productId), "whereClause");
      } else if (userId) {
        whereClause = /* @__PURE__ */ __name((r, { eq: eq2 }) => eq2(r.userId, userId), "whereClause");
      }
      const rows = await db.query.reviews.findMany({
        where: /* @__PURE__ */ __name((r, { and: and2, eq: eq2 }) => {
          const conds = [];
        ...
        orderBy: /* @__PURE__ */ __name((r, { desc: desc2 }) => [desc2(r.createdAt)], "orderBy")
      });
      let stats = null;
      if (productId) {
    ...
    returnsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.returns.findMany({
        where: /* @__PURE__ */ __name((r, { eq: eq2, and: and2 }) => {
          const conditions = [];
    ...
    couponsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.coupons.findMany({
        orderBy: /* @__PURE__ */ __name((cp, { desc: desc2 }) => [desc2(cp.createdAt)], "orderBy")
      });
      return c.json({
    ...
    walletRouter.get("/", async (c) => {
      ...
      const rows = await db.query.walletTransactions.findMany({
        ...
        orderBy: /* @__PURE__ */ __name((t, { desc: desc2 }) => [desc2(t.createdAt)], "orderBy")
      });
...
// ../.wrangler/tmp/bundle-69453K/middleware-loader.entry.ts
init_functionsRoutes_0_6559001376980259();

// ../.wrangler/tmp/bundle-69453K/middleware-insertion-facade.js
init_functionsRoutes_0_6559001376980259();
...
//# sourceMappingURL=functionsWorker-0.8137196079709053.mjs.map
