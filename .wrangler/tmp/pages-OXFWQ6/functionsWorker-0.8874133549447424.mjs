    ...
    categoriesRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.categories.findMany({
          where: /* @__PURE__ */ __name((cat, { eq: eq3, and: and3 }) => {
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.products.findMany({
          ...
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name((p, { desc: desc3, asc: asc2 }) => {
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          ...
          orderBy: /* @__PURE__ */ __name((o, { desc: desc3 }) => [desc3(o.createdAt)], "orderBy")
        });
        return c.json({
  ...
  "api/routes/addresses.ts"() {
    ...
    addressesRouter.get("/", async (c) => {
      ...
      const rows = await db.query.addresses.findMany({
        where: /* @__PURE__ */ __name((a, { eq: eq3 }) => eq3(a.userId, userId), "where"),
        orderBy: /* @__PURE__ */ __name((a, { desc: desc3 }) => [desc3(a.isDefault), desc3(a.createdAt)], "orderBy")
      });
      return c.json({
...
var init_reviews2 = __esm({
  "api/routes/reviews.ts"() {
    ...
    reviewsRouter.get("/", async (c) => {
      ...
      let whereClause;
      if (productId) {
        whereClause = /* @__PURE__ */ __name((r, { eq: eq3 }) => eq3(r.productId, productId), "whereClause");
      } else if (userId) {
        whereClause = /* @__PURE__ */ __name((r, { eq: eq3 }) => eq3(r.userId, userId), "whereClause");
      }
      const rows = await db.query.reviews.findMany({
        where: whereClause,
        orderBy: /* @__PURE__ */ __name((r, { desc: desc3 }) => [desc3(r.createdAt)], "orderBy")
      });
      let stats = null;
  ...
  "api/routes/returns.ts"() {
    ...
    returnsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.returns.findMany({
        where: /* @__PURE__ */ __name((r, { eq: eq3, and: and3 }) => {
          const conditions = [];
  ...
  "api/routes/coupons.ts"() {
    ...
    couponsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.coupons.findMany({
        orderBy: /* @__PURE__ */ __name((cp, { desc: desc3 }) => [desc3(cp.createdAt)], "orderBy")
      });
      return c.json({
...
// ../.wrangler/tmp/bundle-VISyfz/middleware-loader.entry.ts
init_functionsRoutes_0_709371772397853();

// ../.wrangler/tmp/bundle-VISyfz/middleware-insertion-facade.js
init_functionsRoutes_0_709371772397853();
...
//# sourceMappingURL=functionsWorker-0.8874133549447424.mjs.map
