    ...
    categoriesRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.categories.findMany({
          where: /* @__PURE__ */ __name((cat, { eq: eq2, and: and4 }) => {
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          where: /* @__PURE__ */ __name((o, { eq: eq2, and: and4 }) => {
            const filters = [];
  ...
  "api/routers/returns.ts"() {
    ...
    returnsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.returns.findMany({
        where: /* @__PURE__ */ __name((r, { eq: eq2, and: and4 }) => {
          const conditions = [];
      ...
      try {
        const [
          ...
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name((r, { eq: eq2, and: and4 }) => and4(eq2(r.userId, userId), eq2(r.type, "return")), "where"),
            orderBy: /* @__PURE__ */ __name((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
          }),
          // 6. Cancellations
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name((r, { eq: eq2, and: and4 }) => and4(eq2(r.userId, userId), eq2(r.type, "cancellation")), "where"),
            orderBy: /* @__PURE__ */ __name((r, { desc: desc7 }) => [desc7(r.createdAt)], "orderBy")
          }),
          // 7. Reviews
          ...
          db.query.notifications.findMany({
            where: /* @__PURE__ */ __name((n, { eq: eq2, and: and4, or: or3, isNull: isNull3 }) => and4(
              eq2(n.isRead, 0),
...
// ../.wrangler/tmp/bundle-ZrPlKA/middleware-loader.entry.ts
init_functionsRoutes_0_2621827146034086();

// ../.wrangler/tmp/bundle-ZrPlKA/middleware-insertion-facade.js
init_functionsRoutes_0_2621827146034086();
...
//# sourceMappingURL=functionsWorker-0.09775671978290745.mjs.map
