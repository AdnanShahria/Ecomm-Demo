...
var formatLinks, createPaginatedResponse;
    ...
    productsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.products.findMany({
          ...
          limit,
          offset,
          orderBy: /* @__PURE__ */ __name((p, { desc: desc6, asc: asc2 }) => {
    ...
    ordersRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.orders.findMany({
          ...
          orderBy: /* @__PURE__ */ __name((o, { desc: desc6 }) => [desc6(o.createdAt)], "orderBy")
        });
        return c.json({
  ...
  "api/routers/addresses.ts"() {
    ...
    addressesRouter.get("/", async (c) => {
      ...
      const rows = await db.query.addresses.findMany({
        ...
        orderBy: /* @__PURE__ */ __name((a, { desc: desc6 }) => [desc6(a.isDefault), desc6(a.createdAt)], "orderBy")
      });
      return c.json({
  ...
  "api/routers/reviews.ts"() {
    ...
    reviewsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.reviews.findMany({
        ...
        orderBy: /* @__PURE__ */ __name((r, { desc: desc6 }) => [desc6(r.createdAt)], "orderBy")
      });
      let stats = null;
      if (productId) {
  ...
  "api/routers/coupons.ts"() {
    ...
    couponsRouter.get("/", async (c) => {
      ...
      const rows = await db.query.coupons.findMany({
        orderBy: /* @__PURE__ */ __name((cp, { desc: desc6 }) => [desc6(cp.createdAt)], "orderBy")
      });
      return c.json({
  ...
  "api/routers/wallet.ts"() {
    ...
    walletRouter.get("/", async (c) => {
      ...
      const rows = await db.query.walletTransactions.findMany({
        ...
        orderBy: /* @__PURE__ */ __name((t, { desc: desc6 }) => [desc6(t.createdAt)], "orderBy")
      });
    ...
    notificationsRouter.get("/", async (c) => {
      try {
        ...
        const rows = await db.query.notifications.findMany({
          ...
          orderBy: /* @__PURE__ */ __name((n, { desc: desc6 }) => [desc6(n.createdAt)], "orderBy")
        });
      ...
      try {
        const [
          ...
          db.query.addresses.findMany({
            where: /* @__PURE__ */ __name((a, { eq: eq2 }) => eq2(a.userId, userId), "where"),
            orderBy: /* @__PURE__ */ __name((a, { desc: desc6 }) => [desc6(a.createdAt)], "orderBy")
          }),
          ...
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name((r, { eq: eq2, and: and2 }) => and2(eq2(r.userId, userId), eq2(r.type, "return")), "where"),
            orderBy: /* @__PURE__ */ __name((r, { desc: desc6 }) => [desc6(r.createdAt)], "orderBy")
          }),
          // 6. Cancellations
          db.query.returns.findMany({
            where: /* @__PURE__ */ __name((r, { eq: eq2, and: and2 }) => and2(eq2(r.userId, userId), eq2(r.type, "cancellation")), "where"),
            orderBy: /* @__PURE__ */ __name((r, { desc: desc6 }) => [desc6(r.createdAt)], "orderBy")
          }),
          // 7. Reviews
          ...
          db.query.notifications.findMany({
            where: /* @__PURE__ */ __name((n, { eq: eq2, and: and2, or: or2, isNull: isNull2 }) => and2(
              eq2(n.isRead, 0),
...
var systemRouter, globalRequestCount, apiStartTime;
      ...
      try {
        const [
          ...
          db.query.products.findMany({
            limit: 10,
            orderBy: /* @__PURE__ */ __name((p, { desc: desc6 }) => [desc6(p.rating)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 8,
            where: /* @__PURE__ */ __name((p, { like: like2 }) => like2(p.tags, '%"new-arrival"%'), "where"),
            orderBy: /* @__PURE__ */ __name((p, { desc: desc6 }) => [desc6(p.createdAt)], "orderBy")
          }),
          db.query.products.findMany({
            limit: 4,
          ...
          db.query.products.findMany({
            ...
            orderBy: /* @__PURE__ */ __name((p, { desc: desc6 }) => [desc6(p.soldCount)], "orderBy")
          }),
          db.query.notifications.findMany({
...
// ../.wrangler/tmp/bundle-g3nCkI/middleware-loader.entry.ts
init_functionsRoutes_0_5678900032968975();

// ../.wrangler/tmp/bundle-g3nCkI/middleware-insertion-facade.js
init_functionsRoutes_0_5678900032968975();
...
//# sourceMappingURL=functionsWorker-0.9419575582363053.mjs.map
