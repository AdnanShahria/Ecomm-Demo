...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div 
        className={`fixed inset-0 bg-black/20 backdrop-blur-sm z-30 transition-opacity duration-300 ${isMegaMenuOpen || isNotifOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
        onClick={() => {
      ...
      <header className="sticky top-0 z-40 w-full">
        {/* Main Navbar */}
        <div className="bg-white border-b-2 border-[#FF4500] rounded-b-[2rem] w-full shadow-sm">
          ...
          <div className="flex h-14 md:h-16 items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              >
                <div className="h-8 md:h-10 flex items-center group-hover:scale-110 transition-transform duration-300">
                  <img src="/logo.png" alt="Aurelia" className="h-full w-auto object-contain rounded-xl shadow-sm" />
                </div>
                <div className="flex flex-col justify-center">
                  <span className="text-xl md:text-2xl font-bold text-primary tracking-tight leading-none font-garamond">Aurelia</span>
                </div>
              </div>
            </div>

            <div 
              className="hidden lg:flex flex-1 max-w-2xl px-8 relative group justify-center"
            ...
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <div className="relative">
                ...
                {isNotifOpen && (
                  <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-24 sm:top-full mt-0 sm:mt-8 w-auto sm:w-80 sm:max-w-80 bg-white rounded-2xl shadow-xl border-2 border-[var(--accent)] p-4 z-50 flex flex-col gap-3">
