  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <div className="px-8 py-4 border-b border-gray-100 flex justify-between items-center bg-white/50">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-primary text-white rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20">
              <MessageSquare size={24} />
            </div>
            <div>
              <h2 className="text-xl font-black font-garamond text-primary tracking-tight">Status Update Details</h2>
        ...
        <div className="p-6 space-y-4">
          <div className="relative group">
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-[2rem] p-5 border border-gray-100 min-h-[100px] transition-all group-hover:shadow-2xl group-hover:shadow-primary/5 flex items-center justify-center text-center">
              <p className="text-gray-800 text-base leading-relaxed font-bold font-garamond italic">
                "{message}"
              </p>
            </div>
            <button 
          ...
          <button 
            onClick={onClose}
            className="w-full py-4 bg-primary text-white rounded-2xl font-black uppercase tracking-[0.2em] hover:translate-y-[-2px] hover:shadow-2xl hover:shadow-primary/40 transition-all shadow-xl shadow-primary/20 text-[10px]"
          >
            Acknowledge Message
          </button>
        </div>
