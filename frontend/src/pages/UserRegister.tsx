...
export const UserRegister: React.FC = () => {
  ...
  const [step] = useState<'register' | 'otp'>('register');
    ...
    <div className="min-h-[80vh] flex items-center justify-center pt-8 pb-32 px-4 sm:px-6 lg:px-8 bg-gray-50/50">
      <div className="max-w-md w-full space-y-4 bg-white p-6 rounded-3xl shadow-2xl shadow-primary/5 border border-gray-100">
        <div className="flex p-1 bg-gray-100/80 rounded-xl mb-2">
          <Link
            to="/account/login"
            className="flex-1 py-2.5 text-center text-sm font-bold rounded-lg text-muted hover:text-primary transition-colors"
          >
            Login
          </Link>
          <Link
            to="/account/register"
            className="flex-1 py-2.5 text-center text-sm font-black rounded-lg bg-white text-primary shadow-sm ring-1 ring-black/5"
          >
            SignUP
          </Link>
        </div>
